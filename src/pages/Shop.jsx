  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="bg-gradient-to-r from-primary/90 to-secondary/90 text-white rounded-xl mb-8 p-8">
        ...
        <p className="text-lg opacity-90 max-w-2xl">Discover unique gifts for every occasion. From handcrafted treasures to personalized presents that show how much you care.</p>
      </div>
        ...
        <div className="w-full md:w-3/4">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <button onClick={() => setView('grid')} className={`p-1.5 rounded ${view === 'grid' ? 'bg-surface-200 dark:bg-surface-700' : ''}`}>
                <GridIcon className="w-5 h-5 text-surface-700 dark:text-surface-300" />
              </button>
              <button onClick={() => setView('list')} className={`p-1.5 rounded ${view === 'list' ? 'bg-surface-200 dark:bg-surface-700' : ''}`}>
